...
public class ShiroConfig {
    ...
    //1、生成Realm对象
    @Bean
    public AdminRealm createRealm(){
        return new AdminRealm();
    }
    //2、生成权限管理器
    @Bean
    public DefaultWebSecurityManager createSecurityManager(AdminRealm userRealm){
    ...
    public ShiroFilterFactoryBean createShiroFilter(DefaultWebSecurityManager securityManager){
        ...
        factoryBean.setSuccessUrl("static/index.html");//成功页面
